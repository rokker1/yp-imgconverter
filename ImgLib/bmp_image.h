...
PACKED_STRUCT_BEGIN BitmapInfoHeader {
    ...
    const uint32_t info_header_size = 40; // Размер заголовка
    int32_t image_width = 0;
    int32_t image_height = 0;
    const uint16_t planes_count = 1;
    ...
    const int32_t x_ppm = 11811;
    const int32_t y_ppm = 11811;
    const int32_t colors_in_color_table = 0;
    const int32_t important_color_count = 0x1000000; // hex = 16 777 216
}
PACKED_STRUCT_END
